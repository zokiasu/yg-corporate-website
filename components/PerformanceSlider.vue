    ...
    >
      <SwiperSlide v-for="i in idVideos" :key="i">
        <div class="flex items-center justify-center">
          <iframe
            :src="`https://www.youtube.com/embed/${i}?disablekb=1&rel=0&allowfullscreen=1&iv_load_policy=3&cc_load_policy=0&playsinline=1&showinfo=0&modestbranding=1&fs=1&vq=hd1440`"
            frameborder="0"
